...
(1, 'Super Admin',  'Full system access — can manage everything',          100, '{"procurement":{"create":true,"read":true,"update":true,"delete":true,"advance":true,"comment":true,"upload_document":true},"workflow":{"manage":true,"configure_steps":true},"user_management":{"create":true,"read":true,"update":true,"delete":true,"assign_role":true},"role_management":{"create":true,"read":true,"update":true,"delete":true,"assign_permissions":true},"vendor":{"create":true,"read":true,"update":true,"delete":true},"claim":{"create":false,"read":true,"update":true,"delete":true,"forward":true,"sendback":true},"po":{"create":true,"read":true,"update":true,"delete":true},"payment":{"create":true,"read":true},"report":{"view":true,"export":true},"audit":{"view":true}}', 1),
(2, 'Vendor',       'Vendor company employee — can submit claims',        10,  '{"procurement":{"create":false,"read":true,"update":false,"delete":false,"advance":false,"comment":false,"upload_document":true},"workflow":{"manage":false,"configure_steps":false},"user_management":{"create":false,"read":false,"update":false,"delete":false,"assign_role":false},"role_management":{"create":false,"read":false,"update":false,"delete":false,"assign_permissions":false},"vendor":{"create":false,"read":true,"update":false,"delete":false},"claim":{"create":true,"read":true,"update":false,"delete":false,"forward":false,"sendback":false},"po":{"create":false,"read":true,"update":false,"delete":false},"payment":{"create":false,"read":true},"report":{"view":true,"export":false},"audit":{"view":false}}', 1),
